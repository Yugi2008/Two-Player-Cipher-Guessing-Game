...
void Init_LCD();
void InitGraphics(Graphics_Context *gfxContext);
...
void InitGraphics(Graphics_Context *gfxContext) {
    ...
    Graphics_initContext(gfxContext,
                         &g_sCrystalfontz128x128,
                         &g_sCrystalfontz128x128_funcs);
    Graphics_setForegroundColor(gfxContext, GRAPHICS_COLOR_YELLOW);
    Graphics_setBackgroundColor(gfxContext, GRAPHICS_COLOR_BLACK);
